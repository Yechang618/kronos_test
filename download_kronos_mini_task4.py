...
snapshot_download(
    ...
    local_dir="trained/task4/tokenizer/best_model",   
...
snapshot_download(
    ...
    local_dir="trained/task4/basemodel/best_model",    
    # local_dir_use_symlinks=False
)

print("✅ Kronos-mini and Tokenizer downloaded to ./trained/task4/basemodel/best_model and ./trained/task4/tokenizer/best_model/")